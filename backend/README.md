...
## Project Structure
    ...
    ├── testerrornotificati_37473  # Django project configurations
...
1. Clone this repo and `cd testerrornotificati_37473`
...
2. Clone this repo and `cd testerrornotificati_37473`
